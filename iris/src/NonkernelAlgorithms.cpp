                                      ...
                                      int x2,int y2)
{
    ...
    for (int y=y1; y<=y2; ++y)
    {
        for (int x=x1; x<=x2; ++x)
        {
            ...
            r=static_cast<unsigned char>(temp.red*(1+red/100.0));
            g=static_cast<unsigned char>(temp.green*(1+green/100.0));
            b=static_cast<unsigned>(temp.blue*(1+blue/100.0));
                                        ...
                                        int x2,int y2)
{
    ...
    for (int y=y1; y<=y2; ++y)
    {
        for (int x=x1; x<=x2; ++x)
        {
            unsigned char *i_map=NULL,*o_map=NULL;
